...
//        p.setMargins((int)Width/2,(int)Height/2,(int)Width/2,(int)Height/2);
    ...
    private void MoveView(){
        ...
        set.playTogether(
                ObjectAnimator.ofFloat(showimg, "translationX",tx).setDuration(600),
                ObjectAnimator.ofFloat(showimg, "translationY",ty).setDuration(600),
                ObjectAnimator.ofFloat(MainView,"alpha",1).setDuration(600)
